...
commonData:any
  ...
  this.commonData = [
    {
      ...
      num:this.topCardDetails.totMachine+'/'+this.topCardDetails.totCount,
 ...
 
  {
    ...
    num:this.topCardDetails.prdkgs +'/'+this.topCardDetails.uptoPrdkgs , 
...
},
 {
  ...
  num:this.topCardDetails. othProdn +'/'+this.topCardDetails.uptoOthProdn ,
...
}, 
{
  ...
  // icon:'course-1', 
  num:this.topCardDetails.wasteper +'/'+ this.topCardDetails.wasteper ,
...
},
 {
  ...
  // icon: 'rate',
  num: this.topCardDetails.rg1TKgs +'/'+this.topCardDetails.rg1PKgs , 
  title: 'UTD RG1 Prodn /UTD Packed Prodn',
  color: 'secondary'
},
 {
 icon:'sale',
  num: this.topCardDetails.avgCnt +'/'+this.topCardDetails.uptoAvgCnt , 
...
},
{
  ...
  num: this.topCardDetails.utilPer  +'/'+this.topCardDetails.uptoUtilPer , 
...
},
{
  ...
  style: 'font-size: 25px; display: inline-block; border-radius: 50%; padding: 30px; color: rgb(80, 202, 196);',
 num: this.topCardDetails.effPer  +'/'+this.topCardDetails.uptoEffPer , 
