...
@NgModule({
  declarations: [ContentComponent, HeaderComponent, SidebarComponent, FeathericonComponent, FooterComponent, NotificationComponent, BookmarkComponent, MessageComponent, CartComponent, ThemeComponent, LanguageComponent, ProfileComponent, SvgIconComponent, BreadcrumbComponent, SearchComponent, TapToTopComponent, LoaderComponent, DashmenuComponent,DateComponent     ],
